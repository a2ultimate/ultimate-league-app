...
# Images
IMAGE = getattr(settings, "PAYPAL_IMAGE", "https://www.paypal.com/en_US/i/btn/x-click-but6.gif")
...
SANDBOX_IMAGE = getattr(settings, "PAYPAL_SANDBOX_IMAGE", "https://www.paypal.com/en_US/i/btn/x-click-but6.gif")
